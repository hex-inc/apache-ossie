    ...
    *,
    ...
    if len(analysis.dataset_names) == 0:
        ...
        if len(eligible_relationship_assignments) == 0:
            ...
            from_to_relationship_assignments = [
                r for r in eligible_relationship_assignments if r.direction == "from_to"
            ]
            relationship_assignment = (
                from_to_relationship_assignments[0]
                or eligible_relationship_assignments[0]
            )
